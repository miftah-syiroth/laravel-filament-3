...
class ArticleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $tags = [
            'teknologi', 'programming', 'web development', 'mobile', 'design',
            'business', 'startup', 'marketing', 'finance', 'health',
            'lifestyle', 'travel', 'food', 'sports', 'education',
            'science', 'art', 'music', 'film', 'books'
        ];
        ...
        // Buat 50 artikel
        Article::factory(50)->create()->each(function ($article) use ($categories, $tags) {
